...
QT_MOC_LITERAL(1, 9, 18), // "onAreaMousePressed"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "late"

    },
    "WorkArea\0onAreaMousePressed\0\0late"
};
...
void WorkArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onAreaMousePressed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkArea::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkArea::onAreaMousePressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkArea::onAreaMousePressed(bool _t1)
{
